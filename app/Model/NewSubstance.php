...
class NewSubstance extends AppModel {
    ...
    public $virtualFields=['first' => 'UPPER(SUBSTR(NewSubstance.name,1,1))'];
    ...
    public function meta($c,$show=false)
    {
        ...
        $Substance=ClassRegistry::init('NewSubstance'); //load the Substance model
        $Identifier=ClassRegistry::init('NewIdentifier');//load the Identifier model
